-- https://dune.com/queries/5191998/
WITH params AS (
  SELECT
...
events AS (
  ...
  WHERE t.model = from_hex('{{model_id}}')
    AND s.evt_block_time >= (SELECT start_time FROM params)
